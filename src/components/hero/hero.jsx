...
import astrotalk from '../../assets/hero/meta1.png';
      ...
      <div className="text-white border-red-700 border-0 font-serif flex  overflow-x-hidden herocontain" style={{background:"radial-gradient(rgb(92 37 108) 1%, rgb(11 30 36))"}} >
        ...
        <div className={`border-0 border-green-600 sm:w-[50%] w-[100%]`}>
          ...
          variants={smaller_top} animate={control} initial="hidden" whileInView="visible" style={{fontFamily:"Trebuchet MS"}}>
            Welcome to The<span style={{color:"rgb(199, 152, 223)"}}> MetaCryst Club</span>
            ...
            >
              <Typewriter
                words={['Materials science ...', 'Metallurgy ...','Metal Forming...']}
                loop={0}
                cursor
                cursorStyle='|'
          ...
          variants={smaller_top} animate={control} initial="hidden" whileInView="visible" style={{
            ...
            Metacryst is a dynamic club dedicated to advancing material science and metallurgy. It conducts engaging sessions on cutting-edge research and diverse activities, fostering innovation and knowledge sharing. Members explore the latest advancements, collaborate on projects, and contribute to the evolving field of material science and engineering.
          </motion.div>
